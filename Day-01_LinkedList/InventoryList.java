...
public class InventoryList {
    ...
    public void searchItem(String keyword) {
        ...
        while (temp != null) {
            if (String.valueOf(temp.id).equals(keyword) || temp.name.equalsIgnoreCase(keyword)) {
                System.out.println("Item: " + temp.name + ", ID: " + temp.id + ", Qty: " + temp.quantity + ", Price: "
                        + temp.price);
                found = true;
            }
            temp = temp.next;
        ...
        do {
            ...
            while (curr.next != null) {
                ...
                if (field.equalsIgnoreCase("name")) {
                    shouldSwap = ascending ? curr.name.compareTo(curr.next.name) > 0
                            : curr.name.compareTo(curr.next.name) < 0;
    ...
    public void displayAll() {
        ...
        while (temp != null) {
            System.out.println(
                    "Item: " + temp.name + ", ID: " + temp.id + ", Qty: " + temp.quantity + ", Price: " + temp.price);
            temp = temp.next;
        }
    }
